...
wget -O /etc/nginx/nginx.conf "http://raw.githubusercontent.com/shigeno143/OCSPanelCentos6/master/nginx.conf"
wget -O /etc/nginx/conf.d/vps.conf "http://raw.githubusercontent.com/shigeno143/OCSPanelCentos6/master/vps.conf"
